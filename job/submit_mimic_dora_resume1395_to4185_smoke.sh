#!/bin/bash
#SBATCH --job-name="dtgpt-mimic-dora-smoke"
...
#SBATCH --mem=60G
#SBATCH --time=2:00:00
#SBATCH --output=logs/mimic_dora_resume1395_to4185_smoke_%j.out
#SBATCH --error=logs/mimic_dora_resume1395_to4185_smoke_%j.err
...
export DTGPT_MAX_STEPS="${DTGPT_MAX_STEPS:-1397}"
...
export DTGPT_SWEEP_CONFIGS="${DTGPT_SWEEP_CONFIGS:-16,32,1,1,8e-6}"
